...
records ανα block. Ακομη κραταμε και εναν πινακα bucket_end που περιεχει τον τρεχων αριθμο 
...
Διαφορετικα, αν υπαρχει το καταλληλο bucket, πρεπει να ελεγξουμε αν
...
αρχικοποίηση ενός άδειου αρχείου κατακερματισμού με όνομα που δινεται σαν ορισμα.
Υστερα, δεσμευει και αρχικοποιει ενα block το οποιο ειναι η επικεφαλιδα και 
εκει περιεχεται το ειδος του αρχειου(στη συγκεκριμενη περιπτωση 2), το  
αναγνωριστικοτου ερχειου, το ονομα, ο αριθμος των buckets(δινεται ως ορισμα) 
και ο αριθμος των records ανα block. 
Σε περίπτωση που εκτελεστεί επιτυχώς, επιστρέφεται 0,ενώ σε διαφορετική περίπτωση -1.
...
ειναι δευτερεύον ευρετήριο κατακερματισμού, αντιγραφει την επικεφαλιδα (με ολες τις 
πληροφοριες) και την επιστρεφει.
Σε περίπτωση που συμβεί οποιοδήποτε σφάλμα, επιστρέφεται τιμή NULL.
...
δοθηκε ως ορισμα και βρισκει το bucket στο οποιο κανει hash το record, αυτη 
τη φορα με βαση το ονομα. Μετα δημιουργει ενα struct στο οποιο κραταμε μονο το  
ονομα και το αναγνωριστικο του block. Aν αυτο το bucket δεν υπαρχει(δηλαδη ειναι 
-1), το δημιουργουμε με τη γνωστη διαδικασια.
Διαφορετικα, αν υπαρχει το καταλληλο bucket, πρεπει να ελεγξουμε αν
χωραει εκει. Οποτε αν δεν χωραει δημιουργουμε ενα νεο bucket το οποιο θα μπει
με τη σειρα του στην αλυσιδα των buckets.
Σε περίπτωση που εκτελεστεί επιτυχώς, επιστρέφεταιο αριθμός του block στο οποίο 
...
δοθηκε ως ορισμα και βρισκει το bucket στο οποιο κανει hash το συγκεκριμενο value
που δοθηκε. Αφου βρει το bucket, πηγαινει στο τελευταιο του block και σειριακα
(προς τα πισω) πηγαινει στο πτωτευον ευρετηριο, στο οποιο κανει ελεγχο για το 
εαν υπαρχει εγγραφη με το συγκεκριμενο ονομα.
Στην περίπτωση αυτη εκτυπωνει τις εγγραφες αυτες και επιστρέφει το πλήθος των blocks  
