...
ht:
	@echo " Compile hp_main ...";
	gcc -g -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/ht_main.c ./src/record.c ./src/ht_table.c -lbf -o ./build/ht_main -O2
...
stat:
	...
	gcc -g -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/stat_main.c ./src/record.c ./src/sht_table.c ./src/ht_table.c -lbf -o ./build/stat_main -O2
